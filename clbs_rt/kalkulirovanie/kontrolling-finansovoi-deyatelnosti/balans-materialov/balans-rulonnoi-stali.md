...
Когда приложение загрузится, значок ![](<../../../.gitbook/assets/8 (1)>) сменится на ![](<../../../.gitbook/assets/9 (1)>). Для открытия получившегося приложения нужно нажать один раз ЛКМ на значок двух прямоугольников. (Красная стрелка на скриншоте ниже).
